...
["Test App"](python/README.md) (with [hierarchy](python/simple_app_with_tests/docs/app/1_hierarchy) ) is the most simple test management tool, that in a nutshell consists of:
